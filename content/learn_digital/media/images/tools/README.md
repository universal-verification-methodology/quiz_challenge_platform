...
Captured for quiz stems — **map / converter / timing panels only**, challenge catalogs hidden.

- `kmap.png` — Karnaugh map + Minimal SOP (`.tool-layout.split-wide`)
- `radix-converter.png` — bit pattern + radix views + ranges/HDL (`#rc-root` with challenges hidden)
